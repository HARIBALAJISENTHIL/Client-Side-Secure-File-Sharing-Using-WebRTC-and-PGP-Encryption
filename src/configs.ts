...
export const pageDescription = 'A client-side secure file sharing using WebRTC and PGP.';

export const githubLink = 'https://github.com/HARIBALAJISENTHIL/secure-file-sharing';
